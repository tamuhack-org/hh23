      ...
      <div className="flex flex-col items-center justify-center max-[593px]:w-full w-[593px] lg:w-[1000px] xl:w-[1280px] rounded-2xl lg:rounded-3xl border-prizes-light-gray border-4 lg:border-8 p-4 sm:p-10 gap-6">
        ...
        <div className="flex flex-col w-full items-center justify-center gap-6 lg:hidden">
          {prizes.map((prize, i) =>
            <div className="flex flex-row justify-center items-center w-full gap-4" key={i}>
              ...
              <div className="flex flex-col rounded-3xl w-full bg-white border-4 border-mint-green p-3 gap-1 text-prizes-gray hover:shadow-mint-green-glow transition-shadow duration-200">
        ...
        <div className="hidden lg:flex flex-col w-full justify-center items-center gap-10">
          <div className="flex flex-row justify-center items-center w-full gap-8 mt-8">
            ...
            <div className="flex flex-row justify-start items-center w-full rounded-3xl border-mint-green border-6 hover:shadow-mint-green-glow transition-shadow duration-200 bg-white p-5 gap-6 text-prizes-gray">
          ...
          <div className="flex flex-row w-full items-stretch justify-center gap-10">
            <div className="flex flex-col w-1/2 rounded-3xl border-mint-green border-6 hover:shadow-mint-green-glow transition-shadow duration-200 bg-white p-5 text-prizes-gray">
              <div className="flex flex-col w-full gap-2">
          ...
          <div className="flex flex-col items-center justify-center gap-10 w-full">
            {prizes.filter((_, i) => i >= 3).map((prize, i) =>
              <div className="flex flex-row justify-center items-center w-full gap-4" key={i}>
                <div className="flex flex-col rounded-3xl w-full bg-white border-6 hover:shadow-mint-green-glow transition-shadow duration-200 border-mint-green p-5 gap-2 text-prizes-gray">
