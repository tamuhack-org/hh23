  ...
  return (
    ...
    >
      <AnimatePresence>
        {openGame && (
          <IframeModal
            url="https://nitroguy.xyz/Rev-Your-Engines/"
            onClose={closeGame}
          />
        )}
      </AnimatePresence>
      <Image
        src="/assets/mountain-stars.svg"
        alt="preload"
        width={0}
        height={0}
        priority
      ...
      <div className="bg-light-theme-yellow bg-gradient-to-t from-[rgb(255,22,22,0.5)] to-light-theme-yellow dark:bg-dark-purple dark:from-transparent dark:to-transparent dark:text-black">
        ...
        {/* Small Navbar */}
        <div
          className={`lg:hidden my-0 w-full bg-light-theme-yellow dark:bg-dark-purple`}
        >
          <SmallNavbar />
        </div>
        ...
        <div className="lg:hidden relative flex flex-col h-auto mt-6 lg:h-screen w-full lg:flex-row px-8 items-center justify-between pt-6 pb-6 lg:pb-0 lg:pt-0 bg-light-mountain-stars dark:bg-mountain-stars-small bg-cover">
          ...
          >
            ...
            <div className="flex flex-row w-full justify-center items-center gap-3 font-extrabold text-sm">
              ...
              <Link
                href="https://forms.gle/HX9ShvWDLuxgVBcG7"
                className="py-2 w-32 text-center bg-transparent rounded-lg border-2 border-light-theme-pink text-light-theme-pink hover:shadow-light-theme-pink-glow dark:border-pale-yellow dark:text-pale-yellow dark:hover:shadow-pale-yellow-glow"
              >
                MENTOR
              </Link>
            </div>
        ...
        <div className="lg:flex relative hidden flex-col h-auto mt-6 w-full px-8 items-center justify-center pt-6 pb-6 lg:pb-0 lg:pt-0 dark:bg-mountain-stars bg-light-mountain-stars bg-cover">
          <div className="flex flex-row justify-center items-center w-full -mb-12 pt-16 -mr-12">
            <div className="w-1/3" />
            <motion.div
              className="flex flex-col items-center gap-5 xl:gap-8 w-2/3"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 1.5 }}
            >
              ...
              <div className="flex flex-row justify-center items-center gap-6 font-extrabold text-sm xl:text-base z-40">
                ...
                <Link
                  href="https://forms.gle/HX9ShvWDLuxgVBcG7"
                  className="py-2 w-52 text-center bg-transparent rounded-lg border-3 transition duration-200 border-light-theme-pink text-light-theme-pink hover:shadow-light-theme-pink-glow dark:border-pale-yellow dark:text-pale-yellow dark:hover:shadow-pale-yellow-glow"
                >
                  MENTOR
                </Link>
              </div>
          ...
          <div className="flex flex-row relative items-end justify-center w-full">
            <motion.div
              className="flex items-center justify-center -mr-12 z-10"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 1 }}
            >
            ...
            <Tooltip label="Drag Me!">
              <motion.div
                className="flex flex-col justify-stretch z-40 -mx-20 cursor-grab active:cursor-grabbing"
                initial={{ x: "-100vw" }}
                animate={{ x: 0 }}
            ...
            <motion.div
              className="flex items-center justify-center -mb-2 min-[1120px]:-mb-4 min-[1500px]:-mb-5 -ml-8 mr-12 z-30"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 1 }}
            >
              <Image
                src="/assets/diner.png"
                width={1100}
                height={200}
                alt="diner"
                className="z-30 glow"
        ...
        {loadingComplete && (
          <>
            ...
            <div
              id="schedule"
              className="flex flex-col items-center bg-schedule-blue w-full px-4 pt-4 lg:pt-0 pb-16 gap-8 lg:gap-16"
            >
              <motion.div
                initial={{ opacity: 0 }}
              ...
              >
                ...
                />
                <Image
                  src="/assets/schedule-title-big.png"
                  width={700}
                  height={200}
                  alt="schedule-title"
