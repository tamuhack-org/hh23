...
const ResourcesSection = () => {
  return (
    <div id="resources" className="flex flex-col w-full justify-center items-center bg-white px-4 py-8 lg:p-24 gap-6 lg:gap-10">
      <motion.div className="flex flex-row justify-center items-center max-[1184px]:w-full w-[1184px]" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }}>
      ...
      <motion.div className="flex flex-col w-full sm:w-[500px] lg:w-[1000px] gap-4 lg:gap-6 lg:mt-6" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} viewport={{ once: true }}>
      ...
      <motion.div className="flex flex-col gap-4 lg:gap-10 w-full sm:w-[500px] lg:w-[900px] lg:mt-8" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} viewport={{ once: true }}>
