...
const ResourceItem = ({ name, link, description }: ResourceItemProps) => {
  return (
    ...
    <Link
      ...
      target="_blank"
      rel="noopener"
      className="flex flex-row w-full justify-start items-center bg-resources-pink hover:shadow-resources-pink-glow transition-shadow duration-200 rounded-2xl p-1 lg:p-3"
    >
